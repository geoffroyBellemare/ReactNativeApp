...
const COMPANY_FORM_PAGES = {
	...
	person: {
		...
		pages: [
			...
			[
				{
					label: "Add person identity document",
					id: PERSON.name,
					fields: PERSON.fields,
					name: PERSON.name,
					exclusif: ["verification"],
